...
.menu li a:first{text-decoration: none;}
.menu_footer_green a{color:#a1c337 ;}
</style>
    ...
    <div class="container d-none d-sm-block">
        <div class="row">
            ...
            <div class="col-md-6">
                <?php wp_nav_menu(array('theme_location' => 'menu-footer')); ?>
                <div class="">
                    <a class="" href="#"><img src="<?php echo $insta; ?>" alt=""></a>
                    <a class="mx-4" href="#"><img src="<?php echo $youtube; ?>" alt=""></a>
                </div>
            </div>
        </div>
    </div>
